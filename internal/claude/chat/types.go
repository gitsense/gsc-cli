 ...
 * Parent-UUID: N/A
 * Version: 1.2.0
 * Description: Added Silent field to StreamProcessor for batch processing support (--no-events flag).
 * Language: Go
...
type StreamProcessor struct {
	...
	// Silent mode suppresses stdout output for batch processing
	Silent         bool
	
	// Debug logger and event writer for improved stream handling
	DebugLogger    *ChatDebugLogger
	EventWriter    *ChatEventWriter
	
	// Track last assistant message for fallback processing
