 ...
 * Block-UUID: 92464da1-7197-40d7-aa10-c3f0041dca63
 * Parent-UUID: c94d7ecc-4b60-46d8-b23c-f06379f0b7da
 * Version: 1.3.1
 ...
 * Language: Go
 * Created-at: 2026-04-26T18:17:59.200Z
 * Authors: GLM-4.7 (v1.0.0), GLM-4.7 (v1.1.0), Gemini 2.5 Flash Lite (v1.2.0), GLM-4.7 (v1.3.0), GLM-4.7 (v1.3.1)
 */
...
func ParseValidationResult(jsonContent string) (*TurnResult, error) {
...
// parseRichValidation converts the rich result struct to TurnResult
func parseRichValidation(result richValidationResult) (*TurnResult, error) {
...
// parseOldValidation converts the legacy result struct to TurnResult
func parseOldValidation(result oldValidationResult) (*TurnResult, error) {
