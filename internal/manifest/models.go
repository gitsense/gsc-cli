 ...
 * Block-UUID: 2708a5fa-d1c9-4b90-8870-bd34e56b068b
 * Parent-UUID: 3c8f1bc5-d234-4560-a188-e7ebc216974d
 * Version: 1.4.0
 * Description: Removed CodeMetadata, ContractMetadata, and ProvenanceEntry structs as they have been moved to internal/traceability and internal/contract packages to resolve circular dependencies.
 * Language: Go
 * Created-at: 2026-02-26T04:18:29.696Z
 * Authors: GLM-4.7 (v1.0.0), Gemini 3 Flash (v1.1.0), GLM-4.7 (v1.2.0), Gemini 3 Flash (v1.3.0), Gemini 3 Flash (v1.3.1), Gemini 3 Flash (v1.4.0)
 */
