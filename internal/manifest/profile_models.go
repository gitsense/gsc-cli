 ...
 * Block-UUID: be2507ae-bb5c-4b4f-91bf-b6ec5c4fa5ba
 * Parent-UUID: N/A
 * Version: 1.0.0
 * Description: Defines the Go structs for Context Profiles, which represent named workspaces containing pre-defined configuration values.
 * Language: Go
