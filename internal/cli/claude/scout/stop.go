 ...
 * Block-UUID: dc1eb302-d8e7-4c13-b807-872bf0f15ca8
 * Parent-UUID: 094d681f-8c5f-4400-be44-ba9124444294
 * Version: 1.6.0
 ...
 * Language: Go
 * Created-at: 2026-04-22T18:42:54.436Z
 * Authors: claude-haiku-4-5-20251001 (v1.0.0), claude-haiku-4-5-20251001 (v1.0.1), GLM-4.7 (v1.0.2), GLM-4.7 (v1.0.3), GLM-4.7 (v1.0.4), GLM-4.7 (v1.1.0), GLM-4.7 (v1.2.0), GLM-4.7 (v1.3.0), GLM-4.7 (v1.4.0), GLM-4.7 (v1.5.0), GLM-4.7 (v1.6.0)
 */
...
func GetSessionProcessInfo(sessionID string) (*intent_workflow.ProcessInfo, error) {
	manager, err := intent_workflow.LoadSession(sessionID)
	if err != nil {
		return nil, err
	}
