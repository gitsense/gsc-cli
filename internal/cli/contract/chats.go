 ...
 * Version: 1.2.0
 * Description: Implements the 'gsc app contract chats' command to list chats associated with a contract, supporting type discovery and JSON output. Removed duplicate resolveContractUUID helper.
 * Language: Go
...
// ChatsCmd implements the 'gsc app contract chats' command
