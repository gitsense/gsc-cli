 ...
 * Block-UUID: 5606c33b-c6ff-45c3-b778-eab1419f522f
 * Parent-UUID: 635c038f-8763-4468-9cb0-b2b971099314
 * Version: 1.0.2
 * Description: CLI commands for executing commands within a contract context and launching workspace tools.
 * Language: Go
 * Created-at: 2026-04-27T18:08:22.532Z
 * Authors: Gemini 3 Flash (v1.0.0), ..., GLM-4.7 (v1.0.0), GLM-4.7 (v1.0.1), GLM-4.7 (v1.0.2)
 */
...
// execContractCmd handles 'gsc app contract exec'
...
// launchContractCmd handles 'gsc app contract launch'
...
func init() {
	// Exec Flags
	execContractCmd.Flags().StringVar(&contractExecUUID, "contract", "", "Contract UUID (required)")
	...
	execContractCmd.MarkFlagRequired("contract")
	execContractCmd.MarkFlagRequired("authcode")
	execContractCmd.MarkFlagRequired("cmd")

	// Launch Flags
	launchContractCmd.Flags().StringVar(&contractUUID, "contract", "", "Contract UUID (required)")
