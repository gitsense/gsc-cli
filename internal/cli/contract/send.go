 ...
 * Block-UUID: 68052b1d-2fd1-4cbf-98f8-fdbd2804227a
 * Parent-UUID: c93fa9a7-34ab-4d70-b31b-fbe5e7b0156e
 * Version: 1.1.4
 * Description: Added --post flag to support direct message insertion into the chat database via the 'chat_message_posted' event.
 * Language: Go
 * Created-at: 2026-04-27T18:09:57.817Z
 * Authors: Gemini 3 Flash (v1.0.0), GLM-4.7 (v1.0.1), GLM-4.7 (v1.0.2), GLM-4.7 (v1.1.0), GLM-4.7 (v1.1.1), GLM-4.7 (v1.1.2), GLM-4.7 (v1.1.3), GLM-4.7 (v1.1.4)
 */
...
// SendCmd represents the 'gsc app contract send' command.
// It is exported to allow registration as a top-level alias ('gsc app send').
...
func init() {
	...
	SendCmd.Flags().StringVar(&contractUUID, "contract", "", "Contract UUID (optional if in workspace)")
