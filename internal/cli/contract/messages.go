 ...
 * Version: 1.2.0
 * Description: Implements the 'gsc app contract messages' command to list and filter messages, supporting truncation, latest slicing, and visual block formatting.
 * Language: Go
...
// MessagesCmd implements the 'gsc app contract messages' command
