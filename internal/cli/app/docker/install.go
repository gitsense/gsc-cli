 ...
 * Block-UUID: c762c753-404a-4b80-989f-2518df6d5f27
 * Parent-UUID: e41c901a-7521-463f-8604-f670697f3e29
 * Version: 1.4.0
 * Description: Fixed command references from 'gsc docker' to 'gsc app docker' for consistency with the CLI command structure.
 * Language: Go
 * Created-at: 2026-05-13T00:50:00.000Z
 * Authors: GLM-4.7 (v1.0.0), Gemini 3 Flash (v1.1.0), GLM-4.7 (v1.2.0), GLM-4.7 (v1.3.0), GLM-4.7 (v1.4.0)
 */
...
for isolated data storage, and pulls the latest GitSense Chat Docker image.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("     gsc app docker start")
		fmt.Println("")
		fmt.Println("  2. (Optional) Point to your existing code:")
		fmt.Println("     gsc app docker configure --repos-dir ~/path/to/your/projects")
