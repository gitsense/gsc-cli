 ...
 * Version: 1.9.0
 * Description: Defines the root command for the 'gsc app analysis' group, managing AI-generated metadata, analysis results, and export/import operations. v1.2.0: Registered the new 'load' command to restore analysis data from JSONL files. v1.3.0: Hid the 'copy' command to reduce maintenance burden. v1.4.0: Removed duplicate command listing from help text. v1.5.0: Unhid the 'copy' command after rewriting it to use dump-then-load approach. v1.6.0: Registered 'get' and 'set' subcommands for the consumer API interface. v1.8.0: Registered 'schema' and 'query' subcommands for analyzer introspection and metadata filtering. v1.9.0: Registered 'delete' subcommand for removing analyzer data with message chain re-linking.
 * Language: Go
 * Created-at: 2026-06-10T03:09:43.580Z
 * Authors: GLM-4.7 (v1.0.0), GLM-4.7 (v1.1.0), GLM-4.7 (v1.2.0), GLM-4.7 (v1.3.0), GLM-4.7 (v1.4.0), GLM-4.7 (v1.5.0), MiMo-v2.5-Pro (v1.6.0), GLM-4.7 (v1.7.0), MiMo-v2.5-Pro (v1.8.0)
 */
...
func RegisterCommand(parent *cobra.Command) {
	...
	AnalysisCmd.AddCommand(DeleteCmd)
	AnalysisCmd.AddCommand(DumpCmd)
	AnalysisCmd.AddCommand(GetCmd)
	AnalysisCmd.AddCommand(LoadCmd)
	AnalysisCmd.AddCommand(QueryCmd)
	AnalysisCmd.AddCommand(SchemaCmd)
