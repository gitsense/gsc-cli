 ...
 * Version: 1.4.1
 * Description: Implements the 'gsc app ws ffp' command to fuzzy find files in the project root and perform actions like diff, edit, or copy.
 * Language: Go
...
// ffpCmd represents the 'gsc app ws ffp' command
