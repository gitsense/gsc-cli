 ...
 * Version: 1.3.0
 * Description: Implements the 'gsc app ws map' command for visualizing and listing workspace blocks across a contract.
 * Language: Go
...
// mapCmd represents the 'gsc app ws map' command
