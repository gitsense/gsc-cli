 ...
 * Block-UUID: 3fbe491e-0640-42a9-9635-1c5b5ac674d3
 * Parent-UUID: f1852a66-a505-4dd0-87be-2ed2b4a06472
 * Version: 2.5.0
 * Description: Defines the structured JSON response for gsc grep. Updated SearchScope to include new ripgrep-compatible flags for JSON output fidelity. Updated SearchRecord to track new search options in statistics database.
 * Language: Go
 * Created-at: 2026-02-06T01:47:07.919Z
 * Authors: GLM-4.7 (v1.0.0), GLM-4.7 (v2.0.0), GLM-4.7 (v2.0.1), GLM-4.7 (v2.1.0), Gemini 3 Flash (v2.2.0), Gemini 3 Flash (v2.3.0), Gemini 3 Flash (v2.4.0), GLM-4.7 (v2.5.0)
 */
...
type SearchRecord struct {
	...
	Globs           string // JSON string of glob patterns
	MaxCount        int
	Hidden          bool
	NoIgnore        bool
}
